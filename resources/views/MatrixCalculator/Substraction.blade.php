...
<body>
    <main>
        ...
        <center><h2 style=" color: LightGreen; font-size: 128%;">Matrix Calculator</h2>
         <center><h2 style=" color: rgb(236, 242, 236); font-size: 101%;">Substraction</h2>
   <div class="container">
        <form id="matrixForm" action="{{url('')}}/MatrixCalculator/Substraction" method="POST">
            @csrf
            <h2>Matrix A</h2>
...
@error('rows2')
    <center><span style="font-size: 15.9px; color: red;">{{$message}}</span></center>
@enderror
            <input type="number" name="columns2" id="columns2" placeholder="Enter number of Columns" required readonly>
@error('columns2')
<br>
    <center><span style="font-size: 15.9px; color: red;">{{$message}}</span></center>
@enderror
    ...
    <script>
        ...
        // Event listener to update matrix input fields on row/column change
         rowsInput.addEventListener('input', function() {
            ...
            rowsInput2.value=rowsInput.value;
        ...
        columnsInput.addEventListener('input', function() {
            ...
            columnsInput2.value=columnsInput.value;
...
@isset($matrix)
 <div class="container">
        ...
        <table class="answer">
            @foreach ($resultSubtraction as $row)
                <tr>
                    @foreach ($row as $value)
                        <td align="center">{{ $value }}</td>
                    @endforeach
