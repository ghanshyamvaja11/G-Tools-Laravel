...
<main>
    @if ($Email)
     <center><h2 style=" color: LightGreen; font-size: 128%;">Matrix Calculator</h2>
         <center><h2 style=" color: rgb(236, 242, 236); font-size: 101%;">Addition</h2>
   <div class="container">
        <form id="matrixForm" action="{{url('')}}/MatrixCalculator/Addition" method="POST">
            @csrf
